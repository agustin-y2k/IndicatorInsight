// williamsr_help_screen.dart
import 'package:flutter/material.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class WilliamsRHelpScreen extends StatelessWidget {
  @override
                ...
                HelpCard(
                  ...
                  items: [
                    ...
                    AppLocalizations.of(context)!
                        .strongBuyRecommendationWilliamsR,
                    AppLocalizations.of(context)!.sellRecommendationWilliamsR,
                    AppLocalizations.of(context)!
                        .strongSellRecommendationWilliamsR,
                    AppLocalizations.of(context)!
...
class HelpCard extends StatelessWidget {
  ...
  Widget _buildListItem(BuildContext context, String item) {
    ...
    if (item == AppLocalizations.of(context)!.buyRecommendationWilliamsR) {
      ...
      iconColor = Colors.red;
        ...
        AppLocalizations.of(context)!.strongBuyRecommendationWilliamsR) {
      iconData = Icons.arrow_upward;
      iconColor = Color.fromARGB(255, 0, 90, 5);
    } else if (item ==
        AppLocalizations.of(context)!.strongSellRecommendationWilliamsR) {
      iconData = Icons.arrow_downward;
