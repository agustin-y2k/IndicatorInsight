// rsi_strategies_screen.dart
import 'package:flutter/material.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class RSIStrategiesScreen extends StatelessWidget {
  @override
            ...
            child: ListView(
              children: [
                ...
                StrategyCard(
                  ...
                  description: AppLocalizations.of(context)!.divergenceRSIDesc,
                  icon: Icons.analytics,
                ),
                StrategyCard(
                  title: AppLocalizations.of(context)!.trendConfirmation,
                  description:
                      AppLocalizations.of(context)!.trengConfirmationRSIDesc,
                  icon: Icons.analytics,
                ),
              ],
            ),
