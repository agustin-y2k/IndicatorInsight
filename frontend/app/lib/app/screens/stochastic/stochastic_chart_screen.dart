// stochasitc chart screen.dart
import 'package:flutter/material.dart';
import 'package:webview_universal/webview_universal.dart';

class StochasticChartScreen extends StatefulWidget {
  final String symbol;

  const StochasticChartScreen({
    Key? key,
    required this.symbol,
  }) : super(key: key);

  @override
  _StochasticChartScreenState createState() => _StochasticChartScreenState();
}

class _StochasticChartScreenState extends State<StochasticChartScreen> {
  @override
...
void main() {
  runApp(MaterialApp(
    home: const StochasticChartScreen(
      symbol: '',
    ),
  ));
}
